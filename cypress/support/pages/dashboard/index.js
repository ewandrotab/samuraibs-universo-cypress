...
class DashboardPage {
    ...
    selectDay(appointmentDate) {
        ...
        let today = new Date()
        let lastDayOfMount = new Date(today.getFullYear(), today.getMonth() + 1, 0)

        if (today.getDate() === lastDayOfMount.getDate()) {
            ...
            cy.contains(el.mounthYearName, monthName)
                .should('be.visible')
        ...
        cy.log(lastDayOfMount.toString());
